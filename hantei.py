...
# 役牌
    def yaku(self, lst):
        ...
        for p in lst[1:]:
            ...
            if p[0] == ji:
                yaku.append(p[0])
            if p[0] in range(45, 48) and p[0] not in yaku:
                yaku.append(p[0])
        return yaku
                ...
                for a in agari:
                    if a not in self.agari:
                        ...
                        if chanta == 2 and not toitoi:
                            print("純チャン", end=" ")
                            han += f"{2 if self.furo else 3}翻 純チャン\n"
                        if chanta == 1 and toitoi:
                            print("混老頭", end=" ")
                            han += "2翻 混老頭\n"
                        if chanta == 1 and not toitoi:
                            print("チャンタ", end=" ")
                            han += f"{1 if self.furo else 2}翻 チャンタ\n"
                        if sansyoku == 2:
                            print("三色同刻", end=" ")
                            han += "2翻 三色同刻\n"
                        if sansyoku == 1:
                            print("三色同順", end=" ")
                            han += f"{1 if self.furo else 2}翻 三色同順\n"
                        if peko == 2:
                            print("二盃口", end=" ")
                            han += "3翻 二盃口\n"
                        if peko == 1:
                        ...
                        if self.ittsu(a):
                            print("一気通貫", end=" ")
                            han += f"{1 if self.furo else 2}翻 一気通貫\n"
                        if sangen == 1:
                            print("小三元", end=" ")
                            han += "2翻 小三元\n"
                        if anko == 1:
                        ...
                        if chinitsu == 1:
                            print("清一色", end=" ")
                            han += f"{5 if self.furo else 6}翻 清一色\n"
                        if not self.furo:
                            print("門前清自摸和", end=" ")
                            han += "1翻 門前清自摸和\n"
                        yaku = self.yaku(a)
